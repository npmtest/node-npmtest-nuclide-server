...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; config.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (fs.isFileSync(CUSTOM_SERVICES_CONFIG_PATH)) {
<span class="cstat-no" title="statement not covered" >    var customConfigs = require(CUSTOM_SERVICES_CONFIG_PATH);</span>
<span class="cstat-no" title="statement not covered" >    configList = configList.concat(customConfigs);</span>
  }
&nbsp;
  return configList;
}
