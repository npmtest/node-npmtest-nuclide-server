...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/utils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/utils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; utils.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function asyncRequest(options) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (options.useQuerystring === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      options.useQuerystring = true;</span>
    }
...
<span class="cstat-no" title="statement not covered" >        var errorJson = body;</span>
<span class="cstat-no" title="statement not covered" >        if (typeof body !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            errorJson = JSON.parse(body);</span>
          } catch (err) {
            // 404 responses aren't currently JSON.
<span class="cstat-no" title="statement not covered" >            errorJson = { message: body };</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        var err = new Error(errorJson.message);</span>
        // Success http status codes range from 200 to 299.
<span class="cstat-no" title="statement not covered" >        err.code = errorJson.code || response.statusCode;</span>
<span class="cstat-no" title="statement not covered" >        reject(err);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        resolve({ body: body, response: response });</span>
      }
    });
  });
}
 ...
 */
<span class="fstat-no" title="function not covered" >function sendTextResponse(response, text, statusCode) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof statusCode === 'number') {</span>
<span class="cstat-no" title="statement not covered" >    response.statusCode = statusCode;</span>
  }
<span class="cstat-no" title="statement not covered" >  response.write(text || '');</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function sendJsonResponse(response, json, statusCode) {</span>
<span class="cstat-no" title="statement not covered" >  response.setHeader('Content-Type', 'application/json');</span>
<span class="cstat-no" title="statement not covered" >  sendTextResponse(response, JSON.stringify(json), statusCode);</span>
}
&nbsp;
/**
  * Parses the request body in an anyc/promise way
  */
<span class="fstat-no" title="function not covered" >function parseRequestBody(httpRequest, isJson) {</span>
<span class="cstat-no" title="statement not covered" >  return new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >    var body = '';</span>
<span class="cstat-no" title="statement not covered" >    httpRequest.on('data', <span class="fstat-no" title="function not covered" >function (data) {</span></span>
<span class="cstat-no" title="statement not covered" >      body += data;</span>
      // too much POST data, kill the connection!
<span class="cstat-no" title="statement not covered" >      if (body.length &gt; MAX_REQUEST_LENGTH) {</span>
<span class="cstat-no" title="statement not covered" >        reject(new Error('body is too big'));</span>
<span class="cstat-no" title="statement not covered" >        httpRequest.connection.destroy();</span>
      }
    });
<span class="cstat-no" title="statement not covered" >    httpRequest.on('end', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return resolve(isJson ? JSON.parse(body) : body);</span>
    });
  });
}
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function getQueryParameters(requestUrl) {</span>
<span class="cstat-no" title="statement not covered" >  var _url$parse = url.parse(requestUrl, true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var query = _url$parse.query;</span>
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function serializeArgs(args) {</span>
<span class="cstat-no" title="statement not covered" >  var argsOnHttp = [];</span>
<span class="cstat-no" title="statement not covered" >  var argTypes = [];</span>
...
<span class="cstat-no" title="statement not covered" >      argsOnHttp.push('');</span>
<span class="cstat-no" title="statement not covered" >      argTypes.push('undefined');</span>
    } else <span class="cstat-no" title="statement not covered" >if (typeof arg === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      argsOnHttp.push(arg);</span>
<span class="cstat-no" title="statement not covered" >      argTypes.push('string');</span>
    } else {
      // object, number, boolean null
<span class="cstat-no" title="statement not covered" >      argsOnHttp.push(JSON.stringify(arg));</span>
<span class="cstat-no" title="statement not covered" >      argTypes.push('object');</span>
    }
  });
 ...
 */
<span class="fstat-no" title="function not covered" >function deserializeArgs(requestUrl) {</span>
<span class="cstat-no" title="statement not covered" >  var _getQueryParameters = getQueryParameters(requestUrl);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var args = _getQueryParameters.args;</span>
<span class="cstat-no" title="statement not covered" >  var argTypes = _getQueryParameters.argTypes;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  args = args || [];</span>
<span class="cstat-no" title="statement not covered" >  argTypes = argTypes || [];</span>
<span class="cstat-no" title="statement not covered" >  var argsArray = Array.isArray(args) ? args : [args];</span>
<span class="cstat-no" title="statement not covered" >  var argTypesArray = Array.isArray(argTypes) ? argTypes : [argTypes];</span>
<span class="cstat-no" title="statement not covered" >  return argsArray.map(<span class="fstat-no" title="function not covered" >function (arg, i) {</span></span>
    // I do this because nulls are normally sent as empty strings.
<span class="cstat-no" title="statement not covered" >    if (argTypesArray[i] === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      return undefined;</span>
    } else <span class="cstat-no" title="statement not covered" >if (argTypesArray[i] === 'string') {</span>
