...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/serviceframework/ClientComponent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/serviceframework/ClientComponent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">29.53% <small>(44 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">23.91% <small>(11 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">19.35% <small>(6 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">25% <small>(27 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/serviceframework/</a> &#187; ClientComponent.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function _asyncToGenerator(fn) {</span> <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >var gen = fn.apply(this, arguments); <span class="cstat-no" title="statement not covered" ></span>return new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span> <span class="cstat-no" title="statement not covered" >var callNext = step.bind(null, 'next'); <span class="cstat-no" title="statement not covered" ></span>var callThrow = step.bind(null, 'throw'); <span class="fstat-no" title="function not covered" ></span>function step(key, arg) {</span> <span class="cstat-no" title="statement not covered" >try { <span class="cstat-no" title="statement not covered" >var info = gen[key](arg); <span class="cstat-no" title="statement not covered" ></span>var value = info.value; </span>} catch (error) { <span class="cstat-no" title="statement not covered" >reject(error); <span class="cstat-no" title="statement not covered" ></span>return; </span>} <span class="cstat-no" title="statement not covered" ></span>if (info.done) { <span class="cstat-no" title="statement not covered" >resolve(value); </span>} else { <span class="cstat-no" title="statement not covered" >Promise.resolve(value).then(callNext, callThrow); </span>} </span>} <span class="cstat-no" title="statement not covered" >callNext(); </span>}); </span>}; </span>}
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function ClientComponent(emitter, socket, requestIdGenerator) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ClientComponent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this._requestIdGenerator = requestIdGenerator;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._typeRegistry = new _nuclideServiceParserLibTypeRegistry2['default']();</span>
<span class="cstat-no" title="statement not covered" >    this._objectRegistry = new Map();</span>
&nbsp;
    // Setup services.
<span class="cstat-no" title="statement not covered" >    var services = config.loadServicesConfig();</span>
<span class="cstat-no" title="statement not covered" >    for (var service of services) {</span>
<span class="cstat-no" title="statement not covered" >      logger.debug('Registering 3.0 service ' + service.name + '...');</span>
...
<span class="cstat-no" title="statement not covered" >          var defs = (0, _nuclideServiceParser.getDefinitions)(service.definition);</span>
<span class="cstat-no" title="statement not covered" >          var proxy = (0, _nuclideServiceParser.getProxy)(service.name, service.definition, _this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          defs.forEach(<span class="fstat-no" title="function not covered" >function (definition) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            switch (definition.kind) {</span>
              case 'alias':
<span class="cstat-no" title="statement not covered" >                logger.debug('Registering type alias ' + name + '...');</span>
<span class="cstat-no" title="statement not covered" >                if (definition.definition != null) {</span>
<span class="cstat-no" title="statement not covered" >                  _this._typeRegistry.registerAlias(name, definition.definition);</span>
                }
<span class="cstat-no" title="statement not covered" >                break;</span>
              case 'interface':
<span class="cstat-no" title="statement not covered" >                logger.debug('Registering interface ' + name + '.');</span>
<span class="cstat-no" title="statement not covered" >                _this._typeRegistry.registerType(name, _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (object) {</span></span>
<span class="cstat-no" title="statement not covered" >                  return yield object._idPromise;</span>
                }), _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (objectId) {</span>
                  // Return a cached proxy, if one already exists, for this object.
<span class="cstat-no" title="statement not covered" >                  if (_this._objectRegistry.has(objectId)) {</span>
<span class="cstat-no" title="statement not covered" >                    return _this._objectRegistry.get(objectId);</span>
                  }
&nbsp;
                  // Generate the proxy by manually setting the prototype of the object to be the
                  // prototype of the remote proxy constructor.
<span class="cstat-no" title="statement not covered" >                  var object = { _idPromise: Promise.resolve(objectId) };</span>
<span class="cstat-no" title="statement not covered" >                  Object.setPrototypeOf(object, proxy[name].prototype);</span>
<span class="cstat-no" title="statement not covered" >                  _this._objectRegistry.set(objectId, object);</span>
...
<span class="cstat-no" title="statement not covered" >        logger.error('Failed to load service ' + service.name + '. Stack Trace:\n' + e.stack);</span>
...
&nbsp;
  _createClass(ClientComponent, [{
    key: 'marshal',
    value: <span class="fstat-no" title="function not covered" >function marshal() {</span>
<span class="cstat-no" title="statement not covered" >      var _typeRegistry;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_typeRegistry = this._typeRegistry).marshal.apply(_typeRegistry, arguments);</span>
    }
  }, {
    key: 'unmarshal',
    value: <span class="fstat-no" title="function not covered" >function unmarshal() {</span>
<span class="cstat-no" title="statement not covered" >      var _typeRegistry2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_typeRegistry2 = this._typeRegistry).unmarshal.apply(_typeRegistry2, arguments);</span>
    }
  }, {
    key: 'registerType',
    value: <span class="fstat-no" title="function not covered" >function registerType() {</span>
<span class="cstat-no" title="statement not covered" >      var _typeRegistry3;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_typeRegistry3 = this._typeRegistry).registerType.apply(_typeRegistry3, arguments);</span>
    }
&nbsp;
    /**
    ...
    value: <span class="fstat-no" title="function not covered" >function callRemoteFunction(functionName, returnType, args) {</span>
...
<span class="cstat-no" title="statement not covered" >      return this._sendMessageAndListenForResult(message, returnType, 'Calling function ' + functionName);</span>
    }
&nbsp;
    /**
    ...
    value: <span class="fstat-no" title="function not covered" >function callRemoteMethod(objectId, methodName, returnType, args) {</span>
<span class="cstat-no" title="statement not covered" >      var message = {</span>
        protocol: 'service_framework3_rpc',
        type: 'MethodCall',
        method: methodName,
...
<span class="cstat-no" title="statement not covered" >      return this._sendMessageAndListenForResult(message, returnType, 'Calling remote method ' + methodName + '.');</span>
    }
&nbsp;
    /**
    ...
    value: <span class="fstat-no" title="function not covered" >function createRemoteObject(interfaceName, args) {</span>
<span class="cstat-no" title="statement not covered" >      var message = {</span>
        protocol: 'service_framework3_rpc',
        type: 'NewObject',
...
<span class="cstat-no" title="statement not covered" >      return this._sendMessageAndListenForResult(message, 'promise', 'Creating instance of ' + interfaceName);</span>
    }
&nbsp;
    /**
    ...
    value: <span class="fstat-no" title="function not covered" >function disposeRemoteObject(objectId) {</span>
<span class="cstat-no" title="statement not covered" >      var message = {</span>
        protocol: 'service_framework3_rpc',
        type: 'DisposeObject',
        requestId: this._requestIdGenerator(),
...
<span class="cstat-no" title="statement not covered" >      return this._sendMessageAndListenForResult(message, 'promise', 'Disposing object ' + objectId);</span>
    }
&nbsp;
    /**
    ...
    value: <span class="fstat-no" title="function not covered" >function _sendMessageAndListenForResult(message, returnType, timeoutMessage) {</span>
<span class="cstat-no" title="statement not covered" >      var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      switch (returnType) {</span>
        case 'void':
<span class="cstat-no" title="statement not covered" >          this._socket.send(message);</span>
<span class="cstat-no" title="statement not covered" >          return; </span>// No values to return.
        case 'promise':
...
<span class="cstat-no" title="statement not covered" >            _this2._socket.send(message);</span>
<span class="cstat-no" title="statement not covered" >            _this2._emitter.once(message.requestId.toString(), <span class="fstat-no" title="function not covered" >function (hadError, error, result) {</span></span>
<span class="cstat-no" title="statement not covered" >              hadError ? reject(decodeError(error)) : resolve(result);</span>
            });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              _this2._emitter.removeAllListeners(message.requestId.toString());</span>
<span class="cstat-no" title="statement not covered" >              reject('Timeout after ' + _config.SERVICE_FRAMEWORK_RPC_TIMEOUT_MS + ' for requestId: ' + message.requestId + ', ' + timeoutMessage + '.');</span>
            }, _config.SERVICE_FRAMEWORK_RPC_TIMEOUT_MS);
          });
        case 'observable':
<span class="cstat-no" title="statement not covered" >          var observable = _rx.Observable.create(<span class="fstat-no" title="function not covered" >function (observer) {</span></span>
<span class="cstat-no" title="statement not covered" >            _this2._socket.send(message);</span>
&nbsp;
            // Listen for 'next', 'error', and 'completed' events.
<span class="cstat-no" title="statement not covered" >            _this2._emitter.on(message.requestId.toString(), <span class="fstat-no" title="function not covered" >function (hadError, error, result) {</span></span>
<span class="cstat-no" title="statement not covered" >              if (hadError) {</span>
<span class="cstat-no" title="statement not covered" >                observer.onError(decodeError(error));</span>
              } else {
<span class="cstat-no" title="statement not covered" >                (0, _assert2['default'])(result);</span>
<span class="cstat-no" title="statement not covered" >                if (result.type === 'completed') {</span>
<span class="cstat-no" title="statement not covered" >                  observer.onCompleted();</span>
                } else <span class="cstat-no" title="statement not covered" >if (result.type === 'next') {</span>
<span class="cstat-no" title="statement not covered" >                  observer.onNext(result.data);</span>
                }
              }
            });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              var disposeMessage = {</span>
                protocol: 'service_framework3_rpc',
                type: 'DisposeObservable',
                requestId: message.requestId
              };
<span class="cstat-no" title="statement not covered" >              _this2._socket.send(disposeMessage);</span>
            };
          });
&nbsp;
<span class="cstat-no" title="statement not covered" >          return observable;</span>
        default:
<span class="cstat-no" title="statement not covered" >          throw new Error('Unkown return type: ' + returnType + '.');</span>
      }
    }
  }]);
&nbsp;
...
<span class="fstat-no" title="function not covered" >function decodeError(encodedError) {</span>
<span class="cstat-no" title="statement not covered" >  if (encodedError != null &amp;&amp; typeof encodedError === 'object') {</span>
<span class="cstat-no" title="statement not covered" >    var resultError = new Error();</span>
<span class="cstat-no" title="statement not covered" >    resultError.message = encodedError.message;</span>
    // $FlowIssue - some Errors (notably file operations) have a code.
<span class="cstat-no" title="statement not covered" >    resultError.code = encodedError.code;</span>
<span class="cstat-no" title="statement not covered" >    resultError.stack = encodedError.stack;</span>
<span class="cstat-no" title="statement not covered" >    return resultError;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return encodedError;</span>
  }
}
