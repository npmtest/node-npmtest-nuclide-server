...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideLocalEventbus.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideLocalEventbus.js</span></h1>
    <h2>
        
        Statements: <span class="metric">30.36% <small>(34 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; NuclideLocalEventbus.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function NuclideLocalEventbus() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, NuclideLocalEventbus);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _get(Object.getPrototypeOf(NuclideLocalEventbus.prototype), 'constructor', this).call(this);</span>
<span class="cstat-no" title="statement not covered" >    this._options = options;</span>
<span class="cstat-no" title="statement not covered" >    this._services = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._enabledServices = loadConfigsOfServiceWithoutServiceFramework();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._enabledServices.forEach(<span class="fstat-no" title="function not covered" >function (service_path) {</span></span>
<span class="cstat-no" title="statement not covered" >      var _require3 = require(service_path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var services = _require3.services;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var serviceId in services) {</span>
<span class="cstat-no" title="statement not covered" >        _this._services[serviceId] = services[serviceId];</span>
      }
    });
&nbsp;
    // Run initialize after all services registered if exists.
<span class="cstat-no" title="statement not covered" >    this._enabledServices.forEach(<span class="fstat-no" title="function not covered" >function (service_path) {</span></span>
<span class="cstat-no" title="statement not covered" >      var _require4 = require(service_path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var initialize = _require4.initialize;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (initialize) {</span>
<span class="cstat-no" title="statement not covered" >        initialize(_this);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _require5 = require('nuclide-commons');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var fsPromise = _require5.fsPromise;</span>
&nbsp;
    // readFile and writeFile aren't exposed as services for performance optimization.
<span class="cstat-no" title="statement not covered" >    this._services['/fs/readFile'] = { handler: fsPromise.readFile };</span>
<span class="cstat-no" title="statement not covered" >    this._services['/fs/writeFile'] = { handler: fsPromise.writeFile };</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return Promise.resolve();</span>
    ...
    key: 'callMethod',
    value: _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (serviceName, methodName, methodArgs, extraOptions) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var serviceId = '/' + serviceName + '/' + methodName;</span>
      // extend the default options with the extra options
<span class="cstat-no" title="statement not covered" >      var service = this._services[serviceId];</span>
<span class="cstat-no" title="statement not covered" >      if (!service) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Cannot call a non registered local service with id: ' + serviceId);</span>
      }
<span class="cstat-no" title="statement not covered" >      return service.handler.apply(this, methodArgs);</span>
    })
  }, {
    key: 'callService',
    value: <span class="fstat-no" title="function not covered" >function callService(serviceName, args) {</span>
<span class="cstat-no" title="statement not covered" >      var serviceFunction = this._services[serviceName];</span>
...
<span class="cstat-no" title="statement not covered" >      return serviceFunction.handler.apply(this, args);</span>
    }
  }, {
    key: 'close',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._enabledServices.forEach(<span class="fstat-no" title="function not covered" >function (service_path) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _require6 = require(service_path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var shutdown = _require6.shutdown;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (shutdown) {</span>
<span class="cstat-no" title="statement not covered" >          shutdown(_this2);</span>
        }
      });
    }
  }]);
