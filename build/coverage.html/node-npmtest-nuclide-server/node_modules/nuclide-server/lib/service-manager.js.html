...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/service-manager.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/service-manager.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; service-manager.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function optionsToString(options) {</span>
<span class="cstat-no" title="statement not covered" >  if (!options) {</span>
<span class="cstat-no" title="statement not covered" >    return '';</span>
  } else <span class="cstat-no" title="statement not covered" >if (options instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >    return '[' + options.map(<span class="fstat-no" title="function not covered" >function (item) {</span></span>
<span class="cstat-no" title="statement not covered" >      return optionsToString(item);</span>
    }).join(', ') + ']';
  } else <span class="cstat-no" title="statement not covered" >if (options instanceof Object) {</span>
<span class="cstat-no" title="statement not covered" >    var keys = Object.keys(options).sort();</span>
...
<span class="cstat-no" title="statement not covered" >      return key + ': ' + optionsToString(options[key]);</span>
    }).join(', ') + '}';
  } else <span class="cstat-no" title="statement not covered" >if (typeof options === 'number' || typeof options === 'boolean' || typeof options === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    return JSON.stringify(options);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    throw Error('Can\'t stringify %o', options);</span>
  }
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function getService(serviceName, options, localImplementationClassPath) {</span>
<span class="cstat-no" title="statement not covered" >  var key = serviceName + '@' + optionsToString(options);</span>
<span class="cstat-no" title="statement not covered" >  if (!cachedServices.has(key)) {</span>
<span class="cstat-no" title="statement not covered" >    logger.debug('Create service instance: ' + key);</span>
<span class="cstat-no" title="statement not covered" >    var serviceInstance = createLocalService(serviceName, localImplementationClassPath, options);</span>
<span class="cstat-no" title="statement not covered" >    cachedServices.set(key, serviceInstance);</span>
  }
<span class="cstat-no" title="statement not covered" >  return cachedServices.get(key);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createLocalService(serviceName, localImplementationClassPath, options) {</span>
<span class="cstat-no" title="statement not covered" >  var serviceModule = require(localImplementationClassPath);</span>
<span class="cstat-no" title="statement not covered" >  var serviceClass = serviceModule[serviceName] || serviceModule;</span>
<span class="cstat-no" title="statement not covered" >  return new serviceClass(options);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getRemoteEventName(serviceName, eventMethodName, serviceOptions) {</span>
<span class="cstat-no" title="statement not covered" >  return getLocalEventName(serviceName, eventMethodName) + '@' + optionsToString(serviceOptions);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getLocalEventName(serviceName, eventMethodName) {</span>
<span class="cstat-no" title="statement not covered" >  return serviceName + '/' + eventMethodName;</span>
}
&nbsp;
module.exports = {
