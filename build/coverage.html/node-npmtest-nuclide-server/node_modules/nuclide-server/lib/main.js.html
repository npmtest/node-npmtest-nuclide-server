...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/main.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/main.js</span></h1>
    <h2>
        
        Statements: <span class="metric">77.97% <small>(46 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; main.js</div>
</div>
<div class="body">
...
var main = _asyncToGenerator(function* (args) {
  ...
  try {
    ...
    var ca = args.ca;
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (key &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >cert </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >ca)</span> {
<span class="cstat-no" title="statement not covered" >      key = _fs2['default'].readFileSync(key);</span>
<span class="cstat-no" title="statement not covered" >      cert = _fs2['default'].readFileSync(cert);</span>
<span class="cstat-no" title="statement not covered" >      ca = _fs2['default'].readFileSync(ca);</span>
    }
...
<span class="cstat-no" title="statement not covered" >    yield (0, _nuclideLogging.initialUpdateConfig)();</span>
<span class="cstat-no" title="statement not covered" >    yield serverStartTimer.onError(e);</span>
<span class="cstat-no" title="statement not covered" >    logger.fatal(e);</span>
<span class="cstat-no" title="statement not covered" >    (0, _nuclideLogging.flushLogsAndExit)(1);</span>
  }
}
&nbsp;
...
&nbsp;
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { var callNext = step.bind(null, 'next'); var callThrow = step.bind(null, 'throw'); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { <span class="cstat-no" title="statement not covered" >reject(error); <span class="cstat-no" title="statement not covered" ></span>return; </span>} if (info.done) { resolve(value); } else { Promise.resolve(value).then(callNext, callThrow); } } callNext(); }); }; }
&nbsp;
/*
...
&nbsp;
process.stderr.on('error', <span class="fstat-no" title="function not covered" >function (error) {</span>
<span class="cstat-no" title="statement not covered" >  throw new Error('Can not write to stderr! :' + error);</span>
});
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  logger.fatal('uncaughtException:', err);</span>
...
process.on('unhandledRejection', <span class="fstat-no" title="function not covered" >function (error, promise) {</span>
<span class="cstat-no" title="statement not covered" >  logger.error('Unhandled promise rejection ' + promise + '. Error:', error);</span>
});
&nbsp;
