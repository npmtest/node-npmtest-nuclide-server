...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideServer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideServer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">44.92% <small>(137 / 305)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">18.28% <small>(17 / 93)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">42.62% <small>(26 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">46.77% <small>(116 / 248)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; NuclideServer.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (serverKey &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >serverCertificate </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >certificateAuthorityCertificate)</span> {
<span class="cstat-no" title="statement not covered" >      var webServerOptions = {</span>
        key: serverKey,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._webServer = https.createServer(webServerOptions, this._app);</span>
    } else {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (trackEventLoop) {
      blocked(<span class="fstat-no" title="function not covered" >function (ms) {</span>
<span class="cstat-no" title="statement not covered" >        logger.info('NuclideServer event loop blocked for ' + ms + 'ms');</span>
      });
    }
&nbsp;
    // Setup 3.0 services.
...
&nbsp;
      ...
      ['get', 'post', 'delete', 'put'].forEach(function (methodName) {
        _this._app[methodName] = function (uri, handler) {
          _this._app.use(uri, <span class="fstat-no" title="function not covered" >function (request, response, next) {</span>
<span class="cstat-no" title="statement not covered" >            if (request.method.toUpperCase() !== methodName.toUpperCase()) {</span>
              // skip if method doesn't match.
<span class="cstat-no" title="statement not covered" >              return next();</span>
            } else {
<span class="cstat-no" title="statement not covered" >              handler(request, response, next);</span>
            }
          });
        };
      });
...
&nbsp;
      ...
      webSocketServer.on('connection', <span class="fstat-no" title="function not covered" >function (socket) {</span>
<span class="cstat-no" title="statement not covered" >        return _this2._onConnection(socket);</span>
      });
      webSocketServer.on('error', <span class="fstat-no" title="function not covered" >function (error) {</span>
<span class="cstat-no" title="statement not covered" >        return logger.error('WebSocketServer Error:', error);</span>
      });
      return webSocketServer;
    }
  }, {
    key: '_getServiceFrameworkServiceAndRegisterEventHandle',
    value: <span class="fstat-no" title="function not covered" >function _getServiceFrameworkServiceAndRegisterEventHandle(serviceConfig, serviceOptions) {</span>
<span class="cstat-no" title="statement not covered" >      var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var localServiceInstance = getService(serviceConfig.name, serviceOptions, serviceConfig.implementation);</span>
<span class="cstat-no" title="statement not covered" >      if (localServiceInstance[EVENT_HANDLE_REGISTERED]) {</span>
<span class="cstat-no" title="statement not covered" >        return localServiceInstance;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var serviceApi = parseServiceApiSync(serviceConfig.definition, serviceConfig.name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      serviceApi.eventMethodNames.forEach(<span class="fstat-no" title="function not covered" >function (methodName) {</span></span>
<span class="cstat-no" title="statement not covered" >        localServiceInstance[methodName].call(localServiceInstance, <span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          var eventName = getRemoteEventName(serviceConfig.name, methodName, serviceOptions);</span>
<span class="cstat-no" title="statement not covered" >          (_this3._eventSubscriptions.get(eventName) || []).forEach(<span class="fstat-no" title="function not covered" >function (clientId) {</span></span>
<span class="cstat-no" title="statement not covered" >            var client = _this3._clients[clientId];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!client) {</span>
<span class="cstat-no" title="statement not covered" >              logger.warn('Client with clientId: %s not found!', clientId);</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            _this3._sendSocketMessage(client, {</span>
...
<span class="cstat-no" title="statement not covered" >      Object.defineProperty(localServiceInstance, EVENT_HANDLE_REGISTERED, { value: true });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return localServiceInstance;</span>
    }
  }, {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          var localServiceInstance = _this4._getServiceFrameworkServiceAndRegisterEventHandle(serviceConfig, serviceOptions);</span>
<span class="cstat-no" title="statement not covered" >          return localServiceInstance[methodName].apply(localServiceInstance, args);</span>
        }, 'post');
      });
    }
  }, {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (urlHandlers) {
<span class="cstat-no" title="statement not covered" >        for (var url in urlHandlers) {</span>
<span class="cstat-no" title="statement not covered" >          var handlerConfig = urlHandlers[url];</span>
<span class="cstat-no" title="statement not covered" >          this._attachUrlHandler(url, handlerConfig.handler, handlerConfig.method);</span>
        }
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (initialize) {
        initialize(this);
      }
    }
  }, {
...
&nbsp;
      // Setup error handler.
      this._app.use(<span class="fstat-no" title="function not covered" >function (error, request, response, next) {</span>
<span class="cstat-no" title="statement not covered" >        if (error) {</span>
<span class="cstat-no" title="statement not covered" >          sendJsonResponse(response, { code: error.code, message: error.message }, 500);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          next();</span>
    ...
    value: function _setupHeartbeatHandler() {
      var _this6 = this;
&nbsp;
      this._registerService('/' + _config.HEARTBEAT_CHANNEL, _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* () {</span>
<span class="cstat-no" title="statement not covered" >        return _this6._version;</span>
      }), 'post', true);
    }
  }, {
    ...
    value: function _setupServiceFrameworkSubscriptionHandler() {
      var _this7 = this;
&nbsp;
      this._registerService('/serviceFramework/subscribeEvent', <span class="fstat-no" title="function not covered" >function (serviceOptions, clientId, serviceName, methodName) {</span>
&nbsp;
        // Create the service instance and register the event handle.
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _serviceWithServiceFrameworkConfigs$filter = _this7._serviceWithServiceFrameworkConfigs.filter(<span class="fstat-no" title="function not covered" >function (config) {</span></span>
<span class="cstat-no" title="statement not covered" >          return config.name === serviceName;</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _serviceWithServiceFrameworkConfigs$filter2 = _slicedToArray(_serviceWithServiceFrameworkConfigs$filter, 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var serviceConfig = _serviceWithServiceFrameworkConfigs$filter2[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _this7._getServiceFrameworkServiceAndRegisterEventHandle(serviceConfig, serviceOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var eventName = getRemoteEventName(serviceName, methodName, serviceOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _this7._eventSubscriptions.set(eventName, (_this7._eventSubscriptions.get(eventName) || new Set()).add(clientId));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        logger.debug(clientId + ' subscribed to ' + eventName);</span>
      }, 'post');
&nbsp;
      this._registerService('/serviceFramework/unsubscribeEvent', <span class="fstat-no" title="function not covered" >function (serviceOptions, clientId, serviceName, methodName) {</span>
<span class="cstat-no" title="statement not covered" >        var eventName = getRemoteEventName(serviceName, methodName, serviceOptions);</span>
<span class="cstat-no" title="statement not covered" >        if (_this7._eventSubscriptions.has(eventName)) {</span>
<span class="cstat-no" title="statement not covered" >          _this7._eventSubscriptions.get(eventName)['delete'](clientId);</span>
        }
<span class="cstat-no" title="statement not covered" >        logger.debug(clientId + ' unsubscribed to ' + eventName);</span>
      }, 'post');
    }
  }, {
    key: 'connect',
...
&nbsp;
      return new Promise(function (resolve, reject) {
        ...
        _this8._webServer.on('error', <span class="fstat-no" title="function not covered" >function (e) {</span>
<span class="cstat-no" title="statement not covered" >          _this8._webServer.removeAllListeners();</span>
...
&nbsp;
    ...
    key: 'callService',
    value: <span class="fstat-no" title="function not covered" >function callService(serviceName, args) {</span>
<span class="cstat-no" title="statement not covered" >      var serviceFunction = this._serviceRegistry[serviceName];</span>
<span class="cstat-no" title="statement not covered" >      if (!serviceFunction) {</span>
<span class="cstat-no" title="statement not covered" >        throw Error('No service registered with name: ' + serviceName);</span>
      }
<span class="cstat-no" title="statement not covered" >      return serviceFunction.apply(this, args);</span>
    }
&nbsp;
    /**
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this._serviceRegistry[serviceName]) {
<span class="cstat-no" title="statement not covered" >        throw new Error('A service with this name is already registered:', serviceName);</span>
      }
...
&nbsp;
      ...
      this._app[loweredCaseMethod](serviceName, _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (request, response, next) {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          var result = yield _this9.callService(serviceName, deserializeArgs(request.url));</span>
<span class="cstat-no" title="statement not covered" >          if (isTextResponse) {</span>
<span class="cstat-no" title="statement not covered" >            sendTextResponse(response, result || '');</span>
          } else {
<span class="cstat-no" title="statement not covered" >            sendJsonResponse(response, result);</span>
          }
        } catch (e) {
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function _attachUrlHandler(url, handler) {</span>
<span class="cstat-no" title="statement not covered" >      var method = arguments.length &lt;= 2 || arguments[2] === undefined ? 'get' : arguments[2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._app[method](url, handler);</span>
    }
  }, {
    key: '_onConnection',
    value: <span class="fstat-no" title="function not covered" >function _onConnection(socket) {</span>
<span class="cstat-no" title="statement not covered" >      var _this10 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      logger.debug('WebSocket connecting');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var client = null;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return logger.error('Client #%s error: %s', client ? client.id : 'unkown', e.message);</span>
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      socket.once('message', <span class="fstat-no" title="function not covered" >function (clientId) {</span></span>
<span class="cstat-no" title="statement not covered" >        client = _this10._clients[clientId] = _this10._clients[clientId] || { subscriptions: {}, id: clientId, messageQueue: [] };</span>
        // If an existing client, we close its socket before listening to the new socket.
<span class="cstat-no" title="statement not covered" >        if (client.socket) {</span>
<span class="cstat-no" title="statement not covered" >          client.socket.close();</span>
<span class="cstat-no" title="statement not covered" >          client.socket = null;</span>
        }
<span class="cstat-no" title="statement not covered" >        logger.info('Client #%s connecting with a new socket!', clientId);</span>
<span class="cstat-no" title="statement not covered" >        client.socket = socket;</span>
<span class="cstat-no" title="statement not covered" >        client.messageQueue.splice(0).forEach(<span class="fstat-no" title="function not covered" >function (message) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _this10._sendSocketMessage(client, message.data);</span>
        });
<span class="cstat-no" title="statement not covered" >        socket.on('message', <span class="fstat-no" title="function not covered" >function (message) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _this10._onSocketMessage(client, message);</span>
        });
      });
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (client.socket === socket) {</span>
<span class="cstat-no" title="statement not covered" >          client.socket = null;</span>
        }
<span class="cstat-no" title="statement not covered" >        logger.info('Client #%s closing a socket!', client.id);</span>
    ...
    value: _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (client, message) {</span>
<span class="cstat-no" title="statement not covered" >      message = JSON.parse(message);</span>
<span class="cstat-no" title="statement not covered" >      if (message.protocol &amp;&amp; message.protocol === _config.SERVICE_FRAMEWORK3_CHANNEL) {</span>
<span class="cstat-no" title="statement not covered" >        this._serverComponent.handleMessage(client, message);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _message = message;</span>
<span class="cstat-no" title="statement not covered" >      var serviceName = _message.serviceName;</span>
<span class="cstat-no" title="statement not covered" >      var methodName = _message.methodName;</span>
<span class="cstat-no" title="statement not covered" >      var methodArgs = _message.methodArgs;</span>
<span class="cstat-no" title="statement not covered" >      var serviceOptions = _message.serviceOptions;</span>
<span class="cstat-no" title="statement not covered" >      var requestId = _message.requestId;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        result = yield this.callService('/' + serviceName + '/' + methodName, [serviceOptions].concat(methodArgs));</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        logger.error('Failed to call %s/%s with error %o', serviceName, methodName, e);</span>
<span class="cstat-no" title="statement not covered" >        error = e;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._sendSocketMessage(client, {</span>
    ...
    value: <span class="fstat-no" title="function not covered" >function _sendSocketMessage(client, data) {</span>
...
<span class="cstat-no" title="statement not covered" >      var id = client.id;</span>
<span class="cstat-no" title="statement not covered" >      var socket = client.socket;</span>
<span class="cstat-no" title="statement not covered" >      var messageQueue = client.messageQueue;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      messageQueue.push(message);</span>
<span class="cstat-no" title="statement not covered" >      if (!socket) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      socket.send(JSON.stringify(data), <span class="fstat-no" title="function not covered" >function (err) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          logger.warn('Failed sending socket message to client:', id, data);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          var messageIndex = messageQueue.indexOf(message);</span>
<span class="cstat-no" title="statement not covered" >          if (messageIndex !== -1) {</span>
<span class="cstat-no" title="statement not covered" >            messageQueue.splice(messageIndex, 1);</span>
          }
        }
      });
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      (0, _assert2['default'])(NuclideServer._theServer === this);</span>
<span class="cstat-no" title="statement not covered" >      NuclideServer._theServer = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._webSocketServer.close();</span>
<span class="cstat-no" title="statement not covered" >      this._webServer.close();</span>
<span class="cstat-no" title="statement not covered" >      this._serviceWithoutServiceFrameworkConfigs.forEach(<span class="fstat-no" title="function not covered" >function (service_path) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _require8 = require(service_path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var shutdown = _require8.shutdown;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (shutdown) {</span>
<span class="cstat-no" title="statement not covered" >          shutdown(_this11);</span>
        }
      });
    }
  }], [{
    key: 'shutdown',
    value: <span class="fstat-no" title="function not covered" >function shutdown() {</span>
<span class="cstat-no" title="statement not covered" >      logger.info('Shutting down the server');</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        if (NuclideServer._theServer != null) {</span>
<span class="cstat-no" title="statement not covered" >          NuclideServer._theServer.close();</span>
        }
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        logger.error('Error while shutting down, but proceeding anyway:', e);</span>
      } finally {
<span class="cstat-no" title="statement not covered" >        (0, _nuclideLogging.flushLogsAndExit)(0);</span>
      }
    }
  }]);
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 16:52:19 GMT+0000 (UTC)</div>
</div>
</body>
</html>
