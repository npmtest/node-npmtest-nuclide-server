...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/blocked.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/blocked.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; blocked.js</div>
</div>
<div class="body">
...
module.exports = function (fn) {
  var intervalMs = arguments.length &lt;= 1 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1] === undefined </span>? 100 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[1];</span>
  var thresholdMs = arguments.length &lt;= 2 || <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2] === undefined </span>? 50 : <span class="branch-1 cbranch-no" title="branch not covered" >arguments[2];</span>
&nbsp;
  var start = Date.now();
&nbsp;
  return setInterval(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    var deltaMs = Date.now() - start;</span>
<span class="cstat-no" title="statement not covered" >    var blockTimeMs = deltaMs - intervalMs;</span>
<span class="cstat-no" title="statement not covered" >    if (blockTimeMs &gt; thresholdMs) {</span>
<span class="cstat-no" title="statement not covered" >      fn(blockTimeMs);</span>
    }
