...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideClient.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/NuclideClient.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/</a> &#187; NuclideClient.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function NuclideClient(id, eventbus) {</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &lt;= 2 || arguments[2] === undefined ? {} : arguments[2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, NuclideClient);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this._searchProviders = {};</span>
  }
&nbsp;
  _createClass(NuclideClient, [{
    key: 'getID',
    value: <span class="fstat-no" title="function not covered" >function getID() {</span>
...
<span class="cstat-no" title="statement not covered" >      return this.eventbus.testConnection();</span>
    }
&nbsp;
    // Delegate RPC functions to the NuclideRemoteEventbus class.
  }, {
    key: 'callRemoteFunction',
    value: <span class="fstat-no" title="function not covered" >function callRemoteFunction() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.eventbus.callRemoteFunction.apply(this.eventbus, args);</span>
    }
  }, {
    key: 'createRemoteObject',
    value: <span class="fstat-no" title="function not covered" >function createRemoteObject() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.eventbus.createRemoteObject.apply(this.eventbus, args);</span>
    }
  }, {
    key: 'callRemoteMethod',
    value: <span class="fstat-no" title="function not covered" >function callRemoteMethod() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.eventbus.callRemoteMethod.apply(this.eventbus, args);</span>
    }
  }, {
    key: 'disposeRemoteObject',
    value: <span class="fstat-no" title="function not covered" >function disposeRemoteObject() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.eventbus.disposeRemoteObject.apply(this.eventbus, args);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var _eventbus;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_eventbus = this.eventbus).marshal.apply(_eventbus, arguments);</span>
    }
  }, {
    key: 'unmarshal',
    value: <span class="fstat-no" title="function not covered" >function unmarshal() {</span>
<span class="cstat-no" title="statement not covered" >      var _eventbus2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_eventbus2 = this.eventbus).unmarshal.apply(_eventbus2, arguments);</span>
    }
  }, {
    key: 'registerType',
    value: <span class="fstat-no" title="function not covered" >function registerType() {</span>
<span class="cstat-no" title="statement not covered" >      var _eventbus3;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (_eventbus3 = this.eventbus).registerType.apply(_eventbus3, arguments);</span>
    }
&nbsp;
    /**
    ...
    key: 'makeRpc',
    value: <span class="fstat-no" title="function not covered" >function makeRpc(serviceUri, args, serviceOptions) {</span>
<span class="cstat-no" title="statement not covered" >      var _serviceUri$split = serviceUri.split('/');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _serviceUri$split2 = _slicedToArray(_serviceUri$split, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var serviceName = _serviceUri$split2[0];</span>
<span class="cstat-no" title="statement not covered" >      var methodName = _serviceUri$split2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.eventbus.callServiceFrameworkMethod(serviceName, methodName,</span>
      /* methodArgs */args,
      /* serviceOptions */serviceOptions);
    }
  }, {
    key: 'registerEventListener',
    value: <span class="fstat-no" title="function not covered" >function registerEventListener(eventName, callback, serviceOptions) {</span>
<span class="cstat-no" title="statement not covered" >      return this.eventbus.registerEventListener(eventName, callback, serviceOptions);</span>
    }
&nbsp;
    /**
    ...
    key: 'searchDirectory',
    value: _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (directory, query) {</span>
<span class="cstat-no" title="statement not covered" >      return yield this.eventbus.callMethod(</span>
      /*serviceName*/'search',
    ...
    key: 'doSearchQuery',
    value: <span class="fstat-no" title="function not covered" >function doSearchQuery(rootDirectory, provider, query) {</span>
<span class="cstat-no" title="statement not covered" >      return this.eventbus.callMethod(</span>
      /*serviceName*/'search',
      /*methodName*/'query',
    ...
    value: _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (rootDirectory) {</span>
<span class="cstat-no" title="statement not covered" >      var providers = this._searchProviders[rootDirectory];</span>
<span class="cstat-no" title="statement not covered" >      if (providers) {</span>
<span class="cstat-no" title="statement not covered" >        return providers;</span>
      }
<span class="cstat-no" title="statement not covered" >      providers = yield this.eventbus.callMethod(</span>
      /*serviceName*/'search',
      /*methodName*/'listProviders',
      /*methodArgs*/[rootDirectory],
      /*extraOptions*/{ method: 'POST', json: true });
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._searchProviders[rootDirectory] = providers;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return providers;</span>
    })
  }, {
...
<span class="cstat-no" title="statement not covered" >      if (this.eventbus) {</span>
<span class="cstat-no" title="statement not covered" >        this.eventbus.close();</span>
<span class="cstat-no" title="statement not covered" >        this.eventbus = null;</span>
      }
    }
  }]);
&nbsp;
