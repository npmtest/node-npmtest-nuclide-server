...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/NuclideSearchService.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/NuclideSearchService.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/</a> &#187; NuclideSearchService.js</div>
</div>
<div class="body">
...
&nbsp;
var doSearchDirectory = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (directoryUri, query) {</span>
<span class="cstat-no" title="statement not covered" >  var search = fileSearchers[directoryUri];</span>
<span class="cstat-no" title="statement not covered" >  if (search === undefined) {</span>
<span class="cstat-no" title="statement not covered" >    var directory = remoteUri.parse(directoryUri).path;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var exists = yield fsPromise.exists(directory);</span>
<span class="cstat-no" title="statement not covered" >    if (!exists) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Could not find directory to search : ' + directory);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var stat = yield fsPromise.stat(directory);</span>
<span class="cstat-no" title="statement not covered" >    if (!stat.isDirectory()) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Provided path is not a directory : ' + directory);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    search = yield fileSearchForDirectory(directoryUri);</span>
<span class="cstat-no" title="statement not covered" >    fileSearchers[directoryUri] = search;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return yield search.query(query);</span>
});
&nbsp;
var getSearchProviders = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (cwd) {</span>
<span class="cstat-no" title="statement not covered" >  var checkAvailability = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (providerName) {</span></span>
<span class="cstat-no" title="statement not covered" >    var isAvailable = yield providers[providerName].isAvailable(cwd);</span>
<span class="cstat-no" title="statement not covered" >    return isAvailable ? { name: providerName } : null;</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  var validPromises = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var _name in providers) {</span>
<span class="cstat-no" title="statement not covered" >    validPromises.push(checkAvailability(_name));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var results = yield Promise.all(validPromises);</span>
<span class="cstat-no" title="statement not covered" >  return results.filter(<span class="fstat-no" title="function not covered" >function (provider) {</span></span>
<span class="cstat-no" title="statement not covered" >    return !!provider;</span>
  });
});
&nbsp;
var doSearchQuery = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (cwd, provider, query) {</span>
<span class="cstat-no" title="statement not covered" >  var currentProvider = providers[provider];</span>
<span class="cstat-no" title="statement not covered" >  if (!currentProvider) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid provider: ' + provider);</span>
  }
<span class="cstat-no" title="statement not covered" >  var results = yield currentProvider.query(cwd, query);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function addProvider(name, provider) {</span>
<span class="cstat-no" title="statement not covered" >  providers = providers || {};</span>
<span class="cstat-no" title="statement not covered" >  if (providers[name]) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(name + ' has already been added as a provider.');</span>
  }
<span class="cstat-no" title="statement not covered" >  providers[name] = provider;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function clearProviders() {</span>
<span class="cstat-no" title="statement not covered" >  providers = undefined;</span>
}
&nbsp;
function initialize(server) {}
&nbsp;
<span class="fstat-no" title="function not covered" >function shutdown(server) {</span>
<span class="cstat-no" title="statement not covered" >  clearProviders();</span>
<span class="cstat-no" title="statement not covered" >  for (var k in fileSearchers) {</span>
<span class="cstat-no" title="statement not covered" >    fileSearchers[k].dispose();</span>
  }
<span class="cstat-no" title="statement not covered" >  fileSearchers = Object.create(null);</span>
}
&nbsp;
module.exports = {
