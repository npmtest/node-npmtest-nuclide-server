...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/SourceControlService.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/SourceControlService.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/</a> &#187; SourceControlService.js</div>
</div>
<div class="body">
...
'use babel';
&nbsp;
<span class="fstat-no" title="function not covered" >function getHgRepository(directoryPath) {</span>
<span class="cstat-no" title="statement not covered" >  var _require = require('nuclide-source-control-helpers');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var findHgRepository = _require.findHgRepository;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return Promise.resolve(findHgRepository(directoryPath));</span>
}
