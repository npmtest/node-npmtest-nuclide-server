...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/FileSystemService.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/FileSystemService.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">39.05% <small>(41 / 105)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nuclide-server/node_modules/nuclide-server/lib/services/</a> &#187; FileSystemService.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var newFile = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (filePath) {</span>
<span class="cstat-no" title="statement not covered" >  var isExistingFile = yield fsPromise.exists(filePath);</span>
<span class="cstat-no" title="statement not covered" >  if (isExistingFile) {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
<span class="cstat-no" title="statement not covered" >  yield fsPromise.mkdirp(pathUtil.dirname(filePath));</span>
<span class="cstat-no" title="statement not covered" >  yield fsPromise.writeFile(filePath, '');</span>
...
&nbsp;
var readdir = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (path) {</span>
<span class="cstat-no" title="statement not covered" >  var files = yield fsPromise.readdir(path);</span>
<span class="cstat-no" title="statement not covered" >  var entries = yield Promise.all(files.map(_asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (file) {</span></span>
<span class="cstat-no" title="statement not covered" >    var fullpath = pathUtil.join(path, file);</span>
<span class="cstat-no" title="statement not covered" >    var lstats = yield fsPromise.lstat(fullpath);</span>
<span class="cstat-no" title="statement not covered" >    if (!lstats.isSymbolicLink()) {</span>
<span class="cstat-no" title="statement not covered" >      return { file: file, stats: lstats, isSymbolicLink: false };</span>
    } else {
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        var stats = yield fsPromise.stat(fullpath);</span>
<span class="cstat-no" title="statement not covered" >        return { file: file, stats: stats, isSymbolicLink: true };</span>
      } catch (error) {
<span class="cstat-no" title="statement not covered" >        return { file: file, stats: undefined, isSymbolicLink: true, error: error };</span>
      }
    }
  })));
  // TODO: Return entries directly and change client to handle error.
<span class="cstat-no" title="statement not covered" >  return entries.filter(<span class="fstat-no" title="function not covered" >function (entry) {</span></span>
<span class="cstat-no" title="statement not covered" >    return entry.error === undefined;</span>
  }).map(<span class="fstat-no" title="function not covered" >function (entry) {</span>
<span class="cstat-no" title="statement not covered" >    return { file: entry.file, stats: entry.stats, isSymbolicLink: entry.isSymbolicLink };</span>
  });
}
&nbsp;
/**
 ...
 */
&nbsp;
var copy = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (sourcePath, destinationPath) {</span>
<span class="cstat-no" title="statement not covered" >  var isExistingFile = yield fsPromise.exists(destinationPath);</span>
<span class="cstat-no" title="statement not covered" >  if (isExistingFile) {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
<span class="cstat-no" title="statement not covered" >  yield new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >    var fsPlus = require('fs-plus');</span>
<span class="cstat-no" title="statement not covered" >    fsPlus.copy(sourcePath, destinationPath, <span class="fstat-no" title="function not covered" >function (error) {</span></span>
<span class="cstat-no" title="statement not covered" >      error ? reject(error) : resolve();</span>
    });
  });
<span class="cstat-no" title="statement not covered" >  return true;</span>
}
 ...
 */
&nbsp;
var writeFile = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (path, data, options) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var complete = false;</span>
<span class="cstat-no" title="statement not covered" >  var tempFilePath = yield fsPromise.tempfile('nuclide');</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    yield fsPromise.writeFile(tempFilePath, data, options);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var permissions = null;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      permissions = (yield fsPromise.stat(path)).mode;</span>
    } catch (e) {
...
<span class="cstat-no" title="statement not covered" >    if (permissions != null) {</span>
<span class="cstat-no" title="statement not covered" >      yield fsPromise.chmod(tempFilePath, permissions);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    yield mvPromise(tempFilePath, path);</span>
...
<span class="cstat-no" title="statement not covered" >      yield fsPromise.unlink(tempFilePath);</span>
    }
  }
});
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return fsPromise.exists(path);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findNearestFile(fileName, pathToDirectory) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.findNearestFile(fileName, pathToDirectory);</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function lstat(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.lstat(path);</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function mkdir(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.mkdir(path);</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function mkdirp(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.mkdirp(path);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function realpath(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.realpath(path);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function resolveRealPath(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.realpath(fsPromise.expandHomeDir(path));</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function rename(sourcePath, destinationPath) {</span>
...
<span class="cstat-no" title="statement not covered" >    var fsPlus = require('fs-plus');</span>
<span class="cstat-no" title="statement not covered" >    fsPlus.move(sourcePath, destinationPath, <span class="fstat-no" title="function not covered" >function (error) {</span></span>
<span class="cstat-no" title="statement not covered" >      error ? reject(error) : resolve();</span>
    });
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function rmdir(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.rmdir(path);</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function stat(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.stat(path);</span>
}
&nbsp;
/**
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function unlink(path) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.unlink(path)['catch'](<span class="fstat-no" title="function not covered" >function (error) {</span></span>
 ...
 */
&nbsp;
<span class="fstat-no" title="function not covered" >function readFile(path, options) {</span>
<span class="cstat-no" title="statement not covered" >  return fsPromise.readFile(path, options);</span>
}
&nbsp;
// TODO: Move to nuclide-commons
<span class="fstat-no" title="function not covered" >function mvPromise(sourcePath, destinationPath) {</span>
<span class="cstat-no" title="statement not covered" >  return new Promise(<span class="fstat-no" title="function not covered" >function (resolve, reject) {</span></span>
<span class="cstat-no" title="statement not covered" >    mv(sourcePath, destinationPath, { mkdirp: false }, <span class="fstat-no" title="function not covered" >function (error) {</span></span>
